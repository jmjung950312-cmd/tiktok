import { Layers, Moon, Smartphone, Zap, Shield, FormInput } from 'lucide-react';
...
const features = [
  ...
  },
  {
    icon: Smartphone,
    title: '반응형 디자인',
    description: '모바일부터 데스크톱까지 모든 화면 크기에 최적화된 반응형 레이아웃을 제공합니다.',
  },
  {
    icon: Zap,
    title: '빠른 성능',
  ...
  },
  {
    icon: FormInput,
    title: '폼 처리',
    description: 'react-hook-form + zod 조합으로 타입 안전한 폼 유효성 검증 패턴을 제공합니다.',
  },
  {
    icon: Shield,
    title: '타입 안전성',
    description: 'TypeScript와 zod 스키마를 통해 런타임과 빌드 타임 모두 타입 안전성을 보장합니다.',
  },
];
